...
const EventCard = ({ event }) => {
  ...
  const { ref, inView } = useInView({
    triggerOnce: true, // একবার scroll করলেই animation হবে
    threshold: 0.2,    // 20% visible হলেই trigger হবে
  });
  ...
  return (
    ...
    <motion.div
      ref={ref}
      className="flex h-[230px] bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
