...
const Navbar = () => {
  ...
  return (
    <>
      <nav ref={navbarRef} style={navbarStyle} className="fixed top-0 w-full z-50  py-4 md:py-6 backdrop-blur-xl bg-white/10 shadow-lg transition-transform duration-300 px-6">
