...
export default function Card() {
  return (
    <div className="flex flex-col md:w-[24rem] h-[28rem] gap-2 p-5 shadow-lg cursor-pointer hover:relative hover:bottom-2 transform transition-all hover:duration-[2000ms]">
      <div className="h-[16rem] relative w-full  bg-slate-700 rounded-lg overflow-hidden">
        <div className="flex gap-3 absolute mt-3 ml-3">
            <p className="text-white bg-gray-800 py-1 px-3 rounded-lg">18+</p>
            <p className="text-white bg-gray-800 py-1 px-3 rounded-lg">$30-80</p>
      ...
      <div className="flex gap-5">
        <div className="flex gap-3">
          <span className="inline-block bg-slate-200 rounded-lg p-2 ">Deep House</span>          
        </div>
